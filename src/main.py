if __name__ == "__main__":
    ...
    while LoadGame.running:
        ...
        if LoadGame.game_screen is LoadGame.GameScreen.MAIN_MENU:
            ...
            open_index = next(
                (i for i, open in enumerate(LoadGame.open_list) if open), None
            ...
            for sprite in upgrades:
                if sprite.upgrade == UpgradeType.UPGRADEUI:
                    ...
                    if open_index is not None:
                        ...
                        LoadGame.upgrade_info = sprite.upgrades(
                            open,
                            LoadGame.tower_selected,
                            tower_tier,
                            right_side,
                            upgrades_bought,
                        )
            ...
            if open_index is not None and LoadGame.upgrading != "":
                ...
                setattr(
                    ...
                    LoadGame.upgrading,
                    current_stat * LoadGame.upgrade_info[2],
            ...
            for sprite in shop:
                ...
                if sprite.shop is ShopType.SHOPUI:
                    ...
                    if True in LoadGame.hovering_list:
